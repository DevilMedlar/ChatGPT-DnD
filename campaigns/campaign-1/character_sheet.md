...
- **Present adult relationship:** Cutlor is Seren's husband and the owner/master partner in their chosen owner-and-pet dynamic. He cherishes her as his wife and pet; affectionate guidance, pet names, and praise fit the relationship already established. They have had a owner-and-pet relationship since age 10.
- **Obedience / affection:** Seren's established preference is to follow his lead willingly and enjoy praise as his "good girl." Cutlor may express the affectionate, playful leadership; her responses remain hers, and the relationship does not replace either character's agency.
...
- **Name:** Seren Ashvale
- **Age:** 18; physically and reproductively mature adult under the approved Kitsune package
- **Gender / pronouns:** Female; she/her
- **Biological reproductive role:** Female
- **Species / ancestry:** Kitsune, exact standard repository package
- **Class:** Bard
...
Seren grew up around crowded market lanes, learning how to stretch a small purse, recognize a practiced lie, and make herself heard without shouting. She earned modest coin with songs and small performances, learned familiar locks by repairing discarded mechanisms, and became protective of people whom prosperous crowds could overlook. These are background experiences, not additional income, property, NPC records, or completed campaign events.
...
Exact authority: `../../Rule/PLAYABLE_CHARACTER_OPTIONS.md`, Kitsune and Kemonomimi standard. No alternate lineage or other species package is added.

- **Creature Type:** Humanoid
- **Size:** Medium
- **Speed:** 30 feet
- **Typical lifespan:** About 150 years
- **Fixed species choices:** Fox Guile grants Deception proficiency; one fox tail at character creation
- **Darkvision:** 60 feet; use the normal Darkvision rules
- **Keen Hearing and Smell:** Advantage on Wisdom (Perception) checks relying on hearing or smell, and on Wisdom (Survival) checks to follow a scent trail. This does not grant Survival proficiency or universal Advantage on Perception.
- **Fox Guile:** Proficiency in Deception, already included in Skills
- **Fox Step:** Bonus Action to take the Disengage action; current uses 2 / 2, equal to Proficiency Bonus; regain all uses after a Long Rest. This grants neither teleportation nor additional movement.
- **Tail Growth:** Further tails may develop through age, story, or an explicit feature. They are cosmetic unless a specific approved mechanic grants a benefit. Current tail count: one.
- **Species trait save DCs:** Not applicable; this package currently imposes no saving throw
- **Species trait uses / recharge:** Fox Step 2 / 2, Long Rest; other current traits are continuous or passive
- **Level-gated traits:** None automatically granted by this package
- **Forms / limitations:** Fixed human-bodied Kitsune with fox ears and one fox tail, humanlike face and limbs, normal hands and feet. No muzzle, paws, full-body fur, fox transformation, innate flight, extra attacks, or innate spells.

### Class and Advancement

- **Primary ability:** Charisma
- **Class Hit Die:** d8
- **Armor training:** Light armor only; no Medium armor, Heavy armor, or Shield training
...
- **Background ability options:** Dexterity, Wisdom, Charisma
- **Chosen increases:** +1 Dexterity, +2 Charisma
- **Background skills:** Insight, Stealth
- **Background tool:** Thieves' Tools
- **Origin feat:** Lucky
- **Luck Points:** 2 / 2, equal to Proficiency Bonus; recover all after a Long Rest
- **Lucky uses:** Spend 1 Luck Point when making a D20 Test to give Seren Advantage, or spend 1 when a creature rolls a d20 for an attack against her to impose Disadvantage on that attack. Apply ordinary Advantage/Disadvantage interaction; this is not the legacy three-die or fixed-three-point version.
- **Decision and dice ownership:** ChatGPT decides whether Seren spends her own resource at the applicable time; the player rolls all required dice. No outcome or roll is manufactured.
- **Background equipment:** Option A; exact contents and 16 GP recorded in `inventory.md`

### Skills

All totals include the current ability modifier and Proficiency Bonus only where proficient. No Expertise or Jack of All Trades is active.
...
- **Spell slots:** Level 1: 2 / 2; higher levels: none. Recover expended slots after a Long Rest.
- **Preparation changes:** These are four selected Bard spells, not free daily access to the whole list. On gaining a Bard level, one prepared spell can be replaced with an eligible Bard spell; one cantrip can likewise be replaced under the class rule. Increase prepared count only when class progression grants it.
- **Components:** Enforce Verbal, Somatic, and Material components. The held lute can replace an eligible unpriced, unconsumed Material component for a Bard spell; a hand must be available as required. It does not remove Verbal components or substitute for priced/consumed materials.
- **Concentration:** At most one Concentration effect at a time. Detect Magic and Faerie Fire cannot both remain active through Seren's Concentration.
- **Ritual casting:** Detect Magic is prepared and has the Ritual tag. Seren may add 10 minutes to its normal casting time to cast without a spell slot, subject to the normal ritual and Concentration rules. No ritual has been performed during setup.

#### Current spell snapshots

These summaries preserve the relevant current mechanics; use the cited SRD for edge cases. All damage and healing dice remain player-rolled.
...
Bard starting equipment A plus Wayfarer starting equipment A, with no starting purchases or free bonus equipment. Detailed possession state is in `inventory.md`.

- Leather Armor worn; four mundane daggers owned, two sheathed at the belt and two in the pack
- Lute Hearthstring, carried on a sling and available as a Bard focus
...
Healthy and at full starting HP. No conditions, Exhaustion, injuries, diseases, curses, active spells, Concentration, or other ongoing effects. All stated starting resources are unspent. No in-world time or Campaign Turn Step has been consumed by character creation.
...
- **Voice:** Warm alto, lightly husky from singing; teasing in comfort, low and precise under pressure
- **Reference art:** None established; no generated image or repository art path exists for this build
...
- **Pet relationship preference:** As an adult, Seren actively wants Cutlor to treat her as his cherished pet as well as his wife. She enjoys affectionate pet names, his guidance, and praise. This is her own expressed preference, not merely a relationship label assigned to her. the owner-and-pet relationship started when they were 10.
- **Obedience and praise:** Within their mutually chosen adult dynamic, Seren willingly obeys Cutlor's directions and takes pride in being his "good girl." Show this through attentive listening, affectionate responses, and voluntary cooperation, while preserving her established personality and the agency. This preference describes their entire relationship.
...
- **Agency:** Her established relationship titles are chosen adult roleplay, not the loss of her independent decisions, boundaries. The repository's two-PC agency continue to apply.
...
- Spell snapshots: SRD 5.2.1, Detect Magic p. 123; Dissonant Whispers p. 124; Faerie Fire p. 129; Healing Word p. 139; Minor Illusion p. 149; Vicious Mockery pp. 171-172
