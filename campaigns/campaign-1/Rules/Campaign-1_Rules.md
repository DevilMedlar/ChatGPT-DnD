...
**Scope and authorization:** Campaign 1, Cutlor Ashvale only. The earlier delegated implementation below is retained. The player has now explicitly supplied and confirmed Draconic Awakening's once-per-Long-Rest use, one-minute Rage-gated duration, activation timing, healing equal to Constitution modifier, Temporary HP equal to Proficiency Bonus plus Constitution modifier, once-per-own-turn damage equal to Proficiency Bonus, +1 AC, ending conditions, and level-5 flight gate. The player also reaffirmed that revealing horns, wings, or tail is separate from spending Awakening and delegated the remaining appearance. This confirmation supersedes earlier provenance notes saying the numerical limits were not separately player-specified; it does not grant a second Awakening, stack another copy of its benefits, activate it during setup, or refresh resources.

The previously recorded Draconic Guard and armor choice are unchanged by this confirmation. This is additional campaign homebrew, not an official Barbarian feature, a global species rewrite, a new subclass, or an automatically inherited lineage. It intentionally makes Cutlor stronger than the standard Level-1 package; balance has not been playtested. Future changes require an explicit campaign update.
