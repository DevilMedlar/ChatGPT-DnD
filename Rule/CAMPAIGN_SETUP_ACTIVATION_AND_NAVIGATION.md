...
4. initialize `active_game.json` with `campaign_turn_number: 0`, `character_created: false`, the chosen `xp_mode`, completed advancement state for both required core PCs, and `save_revision: 0`
