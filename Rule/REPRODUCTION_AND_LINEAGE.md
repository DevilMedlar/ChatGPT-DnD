...
Campaigns in this repository use a homebrew fantasy framework in which ordinary real-world species or biological compatibility rules do not automatically prevent explicitly adult, consenting fantasy characters from mating, reproducing, becoming pregnant, cross-breeding, or producing hybrid offspring when those themes are chosen in play.
