...
Do **not** recover, infer, reconstruct, or borrow character data, NPC data, items, locations, factions, relationships, quests, story events, secrets, rolls, consequences, visual canon, or any other campaign content from:
...
Historical framework is never evidence that any historical character, NPC, item, location, relationship, quest, or story fact exists in the current campaign.

Campaign folders must not share character, NPC, world, quest, relationship, inventory, session, turn-save, pricing-reference, or art-continuity state unless the player explicitly requests a crossover or import.
